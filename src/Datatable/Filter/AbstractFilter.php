...
abstract class AbstractFilter implements FilterInterface
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setAllowedValues('search_type', [
            'like', 'notLike', 'eq', 'neq', 'lt', 'lte', 'gt', 'gte', 'in', 'notIn', 'isNull', 'isNotNull'
        ]);
     ...
     * @return Composite
     */
    public function addOrExpression(
        Orx $orExpr,
        QueryBuilder $qb,
        $searchType,
        $searchField,
     ...
     * @return Andx
     */
    protected function getBetweenAndExpression(
        Andx $andExpr,
        QueryBuilder $qb,
        $searchField,
        $from,
